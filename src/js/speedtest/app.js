...
window.SendData;
window.myhostName = location.hostname;
window.key;
window.TestServerip;
window.downloadSpeed;
window.uploadSpeed;
window.dataUsedfordl;
window.dataUsedforul;
window.pingEstimate;
window.jitterEstimate;
window.logData;
window.return_data;
window.ReQ = [];
window.StartTime = [];
...
window.uploadTimeing;
window.downloadTimeing;
window.downloadTime;
window.uploadTime;
window.saveTestData;
window.stop = 0;
window.userAgentString;
window.ulFinal = ulDuration * 0.6;
window.dlFinal = dlDuration * 0.6;
window.launch = true;
window.init = true;
window.OpenSpeedTestStart;
window.SelectTest;

window.fianlPingServer;
window.statusPing;
window.statusPingFinal;
window.statusJitter;
window.statusJitterFinal;
window.statusPingTest;
window.pingSendStatus = -1;
window.finalPing = [];
window.pingServer = [];
window.finalJitter = [];
window.pingSendLength = openSpeedTestServerList.length;
...
window.uRest = 0;
window.dualReset;
window.neXT = dlDuration * 1000 - 6000;
window.dualupReset;
window.neXTUp = ulDuration * 1000 - 6000;
